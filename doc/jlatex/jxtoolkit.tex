...
\longdescription{:create-item}{klass label receiver method \= \&rest args \`[メソッド]\\
\> \&key ((:font fontid)\\
\> \&allow-other-keys)}{
...
\longdescription{:create}{\&rest args \= \&key\= items (border-width 0) (font font-courb12) \`[メソッド]\\
...
\longdescription{:create}{name reciever method \= \&rest args \`[メソッド] \\
...
\longdescription{:create}{bitmap-file reciever method \= \&rest args \`[メソッド]\\
\>\&key width height\\
\>\&allow-other-keys)}{
...
\longdescription{:create}{label reciever method \= \&rest args \`[メソッド]\\
