...
\vardesc{sys:*gc-debug*}{
ガーベージコレクションを実行する度にデバッグメッセージをプリントする。}
...
{\em func}が与えていればそれを{\em signal}に対するシグナルハンドラーとしてインストールする。
そうでなければ{\em signal}に対するシグナルハンドラーを返す。
