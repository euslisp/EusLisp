...
\usepackage{eclepsf,makeidx,mytabbing,fancyheadings}
...
\part{EusLisp 基本}
\markboth{EusLisp version 8.00 リファレンスマニュアル (Part I)}{はじめに}
\input{jintro}
\input{jgenerals}
\input{jcontrols}
\input{jobjects}
...
\newpage
\part{EusLisp 拡張}
\markboth{EusLisp version 8.00 リファレンスマニュアル (Part II)}{システム関数}
\input{jsysfunc}
\input{jvxw}
\input{jmthread}
\input{jmatrix}
...
%
\cleardoublepage
\markboth{Euslisp version 8.00 リファレンスマニュアル}{Index}
\footnotesize
\printindex
\end{document}
