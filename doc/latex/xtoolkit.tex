...
\longdescription{:create-item}{klass label receiver method \= \&rest args \`[method]\\
\> \&key ((font fontid)\\
\> \&allow-other-keys)}{
...
\longdescription{:create}{\&rest args \= \&key\= items (border-width 0) (font font-courb12) \`[method]\\
...
\longdescription{:create}{name reciever method \= \&rest args \`[method] \\
...
\longdescription{:create}{bitmap-file reciever method \= \&rest args \`[method]\\
\>\&key width height\\
\>\&allow-other-keys)}{
...
\longdescription{:create}{label reciever method \= \&rest args \`[method]\\
