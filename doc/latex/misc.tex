...
defines the command-lie argument to be parsed.
...
program. Current supported actions are {\tt :value}, {\tt :store},{\tt :store-true},
{\tt :store-false}, {\tt :store-const} and {\tt :append}.
