...
\part{EusLisp Basics}
\markboth{EusLisp version 8.26 Reference Manual (Part I)}{Basics}
\input{intro}
\input{generals}
\input{controls}
\input{objects}
...
\markboth{EusLisp version 8.26 Reference Manual (Part II)}{System Functions}
\input{sysfunc}
\input{mthread}
\markboth{EusLisp version 8.26 Reference Manual (Part III)}{Geometric/Robot Functions}
\input{matrix}
\input{geometry}
\input{contact}
\input{voronoi}
...
\input{manipulator}
% \input{mars-pre}
\markboth{EusLisp version 8.26 Reference Manual (Part IV)}{X-windows}
\input{xwindow}
\input{xtoolkit} \newpage
\markboth{EusLisp version 8.26 Reference Manual (Part V)}{Applications}
\input{database}
\input{http}
% \input{sound}
%
\cleardoublepage
\markboth{EusLisp version 8.26 Reference Manual}{Index}
\footnotesize
\printindex
\end{document}
