...
\funcdesc{version-string-p}{str}{
Return T if STR is string of version defined below, return NIL otherwise.}
\begin{quote}
\begin{verbatim}
...
\end{verbatim}
\end{quote}
\funcdesc{version-string-to-list}{str}{
Return list of version numbers of version string STR}
\begin{verbatim}
  (version-string-to-list "1") ;; => (1)
  (version-string-to-list "1.0.0") ;; => (1 0 0)
\end{verbatim}
\funcdesc{version$<$}{ver1 ver2}{
Return T if version VER1 is lower (older) than VER2, return NIL otherwise}
\begin{verbatim}
  (version< "1" "1.2") ;; => t
  (version< "1.0" "1.0.0") ;; => nil
\end{verbatim}
\funcdesc{version=}{ver1 ver2}{
Return T if version VER1 is equal to VER2, return NIL otherwise}
\begin{verbatim}
  (version= "1" "1") ;; => t
  (version= "1.0" "1.0.0") ;; => t
\end{verbatim}
\funcdesc{version$>$}{ver1 ver2}{
Return T if version VER1 is higher (newer) than VER2, return NIL otherwise}
\begin{verbatim}
  (version> "1.2" "1") ;; => t
  (version> "1.0" "1.0.0") ;; => nil
\end{verbatim}
\funcdesc{version$>=$}{ver1 ver2}{
Return T if version VER1 is higher (newer) than or equal to VER2, return NIL otherwise}
\begin{verbatim}
  (version>= "1.2" "1") ;; => t
  (version>= "1.0" "1.0.0") ;; => t
\end{verbatim}
\funcdesc{version$<=$}{ver1 ver2}{
Return T if version VER1 is lower (older) than or equal to VER2, return NIL otherwise}
\begin{verbatim}
  (version<= "1" "1.2") ;; => t
  (version<= "1.0" "1.0.0") ;; => t
\end{verbatim}
