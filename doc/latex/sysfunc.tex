...
the time elapsed for marking cells, and the time elapsed for reclamation (unmarking and merging).
The time is given in tick counts.}
...
Print debug messages every time the GC is called.}
